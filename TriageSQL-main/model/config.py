...
class CONFIG(object):
    def __init__(self):
        ...
        self.batch_size = 32
        self.epoch = 50
        self.data_max_size = 500  # use 100 if debuging
        ...
        self.test_path = "dataset/final_new_testset.json"
        self.train_path = "dataset/final_new_testset.json"
        self.dev_path = "dataset/final_devset.json"
